...
A type of element that gets its use and meaning from your choice of your words.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display:block will behave like a paragraph and take up all the space horizontally , inline will only go how ever long its own contents reach.
...
5. Explain why git is valuable to a team of developers.
 its branching capabilities allow programmers to work on code independently. it also allows you to commit(save) changes they can go back to at any time to revise
 and edit.
